          ...
          <div className="space-y-6 animate-fade-in">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                Why Choose <span className="text-transparent bg-clip-text bg-gradient-primary">ARAK</span>?
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                ARAK is Libya's premier technology company delivering comprehensive Communication and IT services. 
                We specialize in Managed Services (MSP) that let businesses focus on their core operations while 
                we ensure their technology infrastructure runs flawlessly.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-background rounded-2xl p-6 shadow-card-arak border border-border">
              ...
              <div className="space-y-4">
                {[
                  ...
                  "✔ 99.9999% uptime guarantee for your infrastructure", 
            ...
            <div className="bg-gradient-primary rounded-2xl p-6 text-primary-foreground">
              ...
              <p className="text-primary-foreground/90">
                Once you partner with ARAK, you'll stop thinking about IT interruptions. 
                We take over, so you stay focused on what matters most - growing your business.
              </p>
            </div>
          </div>
        </div>
