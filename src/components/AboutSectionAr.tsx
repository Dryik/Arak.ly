              ...
              <CardContent className="p-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted-foreground">حلول تكنولوجيا المعلومات الشاملة تحت سقف واحد</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 ml-3 flex-shrink-0" />
                    <span className="text-muted-foreground">ضمان وقت تشغيل 99.9999% للبنية التحتية الخاصة بك</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 ml-3 flex-shrink-0" />
                    <span className="text-muted-foreground">مهندسون معتمدون مع خبرة عملية حقيقية</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 ml-3 flex-shrink-0" />
                    <span className="text-muted-foreground">نحن نقدم نتائج على مستوى المؤسسات، حتى للشركات الناشئة</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 ml-3 flex-shrink-0" />
                    <span className="text-muted-foreground">شراكات قوية مع الموردين: HPE، Dell، Cisco، Fortinet، Huawei، ZTE</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 ml-3 flex-shrink-0" />
                    <span className="text-muted-foreground">نحن نفهم احتياجات القطاعات المتخصصة: البنوك والتعليم والصحة والحكومة</span>
                  </li>
                </ul>
                
                <div className="mt-8 p-4 bg-primary/5 rounded-lg border border-primary/20">
                  <p className="text-primary font-medium text-center">
                    بمجرد شراكتك مع ARAK، ستتوقف عن التفكير في انقطاع تكنولوجيا المعلومات. نحن نتولى الأمر، لتبقى أنت مركزاً على عملك.
                  </p>
                </div>
              </CardContent>
            </Card>
