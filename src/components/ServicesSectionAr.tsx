...
import { Network, Monitor, Cloud, Radio, Code, Server, Wrench, Shield } from 'lucide-react';
  ...
  const services = [
    {
      ...
      features: [
        'الألياف البصرية والكابلات المهيكلة',
        'إعداد البنية التحتية الكاملة',
    ...
    },
    {
      ...
      description:
        'Microsoft 365 وأنظمة ERP والبريد الإلكتروني والنسخ الاحتياطي — كل ما يحتاجه موظفوك للعمل',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            نقدم مجموعة شاملة من خدمات تكنولوجيا المعلومات والاتصالات المصممة لتلبية احتياجات عملك
            الفريدة
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <Card
              key={index}
              className="group hover:shadow-elevated transition-all duration-300 hover:-translate-y-1 border-border/50 hover:border-primary/20"
            >
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-muted-foreground">
            تحتاج إلى حل مخصص؟{' '}
            <span className="text-primary font-medium">دعنا نناقش متطلباتك الفريدة</span>
          </p>
        </div>
      </div>
    </section>
